...
export default function RecipePage() {
  ...
  useEffect(() => {
    if (params?.id) {
      const foundRecipe = featuredRecipes.find((r) => r.id === params.id)
    ...
    return (
      <div className="container py-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button onClick={() => router.push("/featured")}>Back to Recipes</Button>
        </div>
      </div>
    )
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <Card className="md:col-span-1 border-green-200 dark:border-green-800">
            <CardContent className="pt-6">
              <h2 className="text-xl font-semibold mb-4 text-green-700 dark:text-green-300">Ingredients</h2>
          ...
          <Card className="md:col-span-2 border-green-200 dark:border-green-800">
            <CardContent className="pt-6">
              <h2 className="text-xl font-semibold mb-4 text-green-700 dark:text-green-300">Instructions</h2>
