    ...
    >
      <Card className="border-green-200 dark:border-green-800">
        ...
        <CardContent className="pt-6 space-y-6">
          <div>
            <h3 className="text-lg font-semibold mb-2 text-green-700 dark:text-green-300">Ingredients</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-2 text-green-700 dark:text-green-300">Instructions</h3>
